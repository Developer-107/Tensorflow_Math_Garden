 ...
 async function loadModel() {
      model = await tf.loadGraphModel('my_model_tfjs/model.json');
...
function predictImage(){
    ...
    const predictedClass = result.argMax(-1);  // Get index of highest value
    predictedClass.print();                        // Shows the single class number


    const output = predictedClass.dataSync()[0];
